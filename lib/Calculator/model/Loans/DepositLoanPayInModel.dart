...
class DepositLoanPayInModel {
  ...
  DepositLoanPayInModel.fromJson(Map<String, dynamic> json) {
  ...
  static List<KeyValueModel> keyValueList(List<DepositLoanPayInModel> list){
    return list.map((e) {
      return KeyValueModel(id: e.pschemeid.toString(), name: e.pLoanpayin.toString());
    }).toList();
  }
}